...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'ankitsisodiya002@gmail.com', // gmail
...
export const sendMail = async function ({to, subject, text, html}){
  let info = await transporter.sendMail({
      from: '"E-commerce" <ankitsisodiya002@gmail.com>', // sender address
      to,
      subject,
      text,
      html
           ...
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
               <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                 <img src="../build/ecommerce.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
               </a>
             </td>
           </tr>
         </table>
